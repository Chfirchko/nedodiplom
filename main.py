...
RES = WIDTH, HEIGHT = 1202, 902  # Размер окна
TILE = 50
...
class Cell:
    ...
    def check_neighbour(self):
        ...
        return rnd.choice(neighbours) if neighbours else False
...
while True:
    ...
    [pygame.draw.rect(sc, colors[i], (cell.x * TILE + 5, cell.y * TILE + 5, TILE - 10, TILE - 10), border_radius=12) for
     i, cell in enumerate(stack)]
    next_cell = current_cell.check_neighbour()
    if next_cell:
